...
export const SPHERE_MODEL = new Model(SPHERE_MESH,
...
export const TRIANGLE_MODEL = new Model(TRIANGLE_MESH, linAlg.createZeroMatrix(4, 1), linAlg.createVector(4, [0, 0, 0, 1]), linAlg.createVector(4, [0.1, 0.1, 0.1, 1]));
